...
def test_release_version_and_contract():
    assert gp.__version__=='0.1.4'; assert len(gp.R_EXPORTS)==406; assert len(gp.IMPLEMENTED_EXPORTS)==406; assert len(gp.PENDING_EXPORTS)==0
