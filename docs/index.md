...
<div><span class="gp-status-value">10 / 10</span><span class="gp-status-label">qualified main workflow families</span></div>
<div><span class="gp-status-value">11</span><span class="gp-status-label">Studio research workflows</span></div>
...
<p>Stable 0.1.5 freezes 567 tests, 10,456/10,456 statements, 5,629/5,648 raw branches = 99.6636%, and zero unexpected, stale or unaudited branch debt.</p>
...
!!! success "Stable archival record"
    Stable `gpbiometricspy 0.1.5` was released on **2026-09-08**. The version DOI is [10.5281/zenodo.22672823](https://doi.org/10.5281/zenodo.22672823), the software concept DOI is [10.5281/zenodo.22150872](https://doi.org/10.5281/zenodo.22150872), and live development proceeds as `0.1.6.dev0`.
