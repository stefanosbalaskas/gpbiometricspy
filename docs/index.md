...
<strong>Development documentation:</strong> this site tracks <code>main</code> (<code>0.1.2.dev0</code>). The latest stable PyPI release is <code>0.1.1</code>.
</div>
...
Start with [Getting started](getting-started.md), run the [Examples](examples/index.md), inspect the [Plot gallery](plot-gallery.md), browse the [26 articles](articles/index.md), or search the [406-function API](api/reference.md).
