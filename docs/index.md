...
<div><span class="gp-status-value">2026-09-11</span><span class="gp-status-label">release date</span></div>
...
<p>Stable 0.1.6 freezes 641 core tests, preserves 10,456/10,456 package statements = 100.00%, 5,629/5,648 raw branches = 99.6636%, and zero unexpected, stale or unaudited branch debt.</p>
