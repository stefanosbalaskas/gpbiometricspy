...
<a class="gp-route-card" href="research-pipeline-blueprint/"><span class="gp-route-label">Architecture</span><h3>Research pipeline blueprint</h3><p>Why ingestion, measurement evidence, processing, alignment, summarisation, modelling, and reporting are kept as explicit stages.</p></a>
