...
The complete Python-native executable version is:

`examples/hands-on/end-to-end-eda-research.py`

It is intentionally separate from `examples/tutorials/`, which remains the frozen 26 R-companion tutorial surface.
